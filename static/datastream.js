...
function showhightestcorr2(selected_column){
    function average(array) {
        var sum = 0;
        for (var i = 0; i < array.length; i++) {
            sum += array[i][0];
            ...
            if (counter == 2) {
                if(tgt2.data().type != "Input-Operator"){//JL3
                    ...
                    if(tgt1.id() != tgt2.id()){
                        ...
                        else if(tgt1.data().type == "Output-Operator"){
                            alert("Cannot connect output to others!");
                            tgt1 = tgt2 = null;
                            counter = 0;
                        }
                        else{
...
async function process_ensamble(){
    ...
    newWindow.document.close();
                    ...
                    //add to humanlist JIANG LE 1968行
                    // var exist1=0
                    // var exist2=0
                    // for (let a=0;a<humanlist.length;a++){
